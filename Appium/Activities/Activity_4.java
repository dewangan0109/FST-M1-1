...
public class Activity4 {
	...
	public void createContact() {
		...
		driver.findElementByXPath("//android.widget.EditText[@text='First name']").sendKeys("Saumya");
		driver.findElementByXPath("//android.widget.EditText[@text='Last name']").sendKeys("Dewangan");
		driver.findElementByXPath("//android.widget.EditText[@text='Phone']").sendKeys("9303789677");
        ...
        Assert.assertEquals(contactName, "Saumya Dewangan");
	}
